...
curl -X GET "https://your-app.com/api/topics" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"

# Test create topic
curl -X POST "https://your-app.com/api/topics" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN" \
  -d '{"title": "Test Topic", "category": "general", "description": "Test", "max_participants": 10}'
```
